...
proc update_PARAM_VALUE.NUMBER_OF_MACS { PARAM_VALUE.NUMBER_OF_MACS } {
	# Procedure called to update NUMBER_OF_MACS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUMBER_OF_MACS { PARAM_VALUE.NUMBER_OF_MACS } {
	# Procedure called to validate NUMBER_OF_MACS
	return true
}

proc update_PARAM_VALUE.NUMBER_OF_MACS_STDLV { PARAM_VALUE.NUMBER_OF_MACS_STDLV } {
	# Procedure called to update NUMBER_OF_MACS_STDLV when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUMBER_OF_MACS_STDLV { PARAM_VALUE.NUMBER_OF_MACS_STDLV } {
	# Procedure called to validate NUMBER_OF_MACS_STDLV
	return true
}
...
proc update_MODELPARAM_VALUE.NUMBER_OF_MACS { MODELPARAM_VALUE.NUMBER_OF_MACS PARAM_VALUE.NUMBER_OF_MACS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUMBER_OF_MACS}] ${MODELPARAM_VALUE.NUMBER_OF_MACS}
}

proc update_MODELPARAM_VALUE.NUMBER_OF_MACS_STDLV { MODELPARAM_VALUE.NUMBER_OF_MACS_STDLV PARAM_VALUE.NUMBER_OF_MACS_STDLV } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUMBER_OF_MACS_STDLV}] ${MODELPARAM_VALUE.NUMBER_OF_MACS_STDLV}
}
